...
#ifndef LOCAL_PLANNER_TEB_H_
#define LOCAL_PLANNER_TEB_H_

#include <ros/ros.h>

// base local planner base class and utilities
#include <anirudh_nav_stack/local_planner.h>
#include <base_local_planner/goal_functions.h>
#include <local_planner_teb/odometry_helper_ros.h>
#include <local_planner_teb/costmap_model.h>


// timed-elastic-band related classes
#include <local_planner_teb/optimal_planner.h>
#include <local_planner_teb/homotopy_class_planner.h>
#include <local_planner_teb/visualization.h>
#include <local_planner_teb/recovery_behaviors.h>
...
// dynamic reconfigure
#include <local_planner_teb/TebLocalPlannerReconfigureConfig.h>
...
/**
  ...
  */
class LocalPlannerTEB : public anirudh_nav_stack::LocalPlanner
{
...
public:
  ...
  /**
    ...
    */
  bool getLocalPlan(std::vector<std::pair<geometry_msgs::Pose2D, double> >& local_plan);
...
private:
  ...
  TebOptimalPlannerPtr planner_; //!< Instance of the underlying optimal planner class
  ...
  boost::shared_ptr<local_planner_teb::CostmapModel> costmap_model_;  
  ...
  local_planner_teb::OdometryHelperRos odom_helper_; //!< Provides an interface to receive the current velocity from the robot
